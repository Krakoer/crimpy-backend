...
VALUES ($1, $2, $3, $4, $5)
RETURNING id, user_id, name, repeater_id, is_favorite, is_assessment, updated_at
`
...
SELECT id, user_id, name, repeater_id, is_favorite, is_assessment, updated_at FROM trainings WHERE id = $1
`
...
SELECT id, user_id, name, repeater_id, is_favorite, is_assessment, updated_at FROM trainings WHERE user_id = $1 AND is_favorite = true ORDER BY name
`
...
SELECT id, user_id, name, repeater_id, is_favorite, is_assessment, updated_at FROM trainings WHERE user_id = $1 ORDER BY name
`
